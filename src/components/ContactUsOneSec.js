  ...
  return (
    <section className="relative w-full h-[90vh] flex items-center justify-start text-white">
      ...
      <div className="relative z-10 text-left px-6 md:px-24 max-w-3xl">
        ...
        >
          Reach Out and Explore Your Study Abroad Journey Today!
        ...
        >
         Embark on an educational adventure beyond borders. Our doors are open to your questions and aspirations. 
         Connect with us to begin your journey of studying abroad and broadening your horizons.
        </motion.p>
